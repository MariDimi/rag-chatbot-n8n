...
1. Google Drive — Your PDF files should be stored in a Google Drive folder
2. Ollama (local) — The workflows use local Ollama models by default. The LLM component can be swapped for any other model you have an API key for
3. Supabase account — Free tier is sufficient → supabase.com
4. Cohere account — Free tier is sufficient → cohere.com
